...
def calculations(time, planet_1, planet_2):
    ...
    for i in range(time):
        ...
        # velocities
        # planet 1
        dvx_pln1 = planet_1.x_vel_list[i] + planet_1.x_accel_list[i] * dt
        planet_1.x_vel_list.append(dvx_pln1)
        dvy_pln1 = planet_1.y_vel_list[i] + planet_1.y_accel_list[i] * dt
        planet_1.y_vel_list.append(dvy_pln1)
        dvz_pln1 = planet_1.z_vel_list[i] + planet_1.z_accel_list[i] * dt
        planet_1.z_vel_list.append(dvz_pln1)
        # planet 2
        dvx_pln2 = planet_2.x_vel_list[i] + planet_2.x_accel_list[i] * dt
        planet_2.x_vel_list.append(dvx_pln2)
        dvy_pln2 = planet_2.y_vel_list[i] + planet_2.y_accel_list[i] * dt
        planet_2.y_vel_list.append(dvy_pln2)
        dvz_pln2 = planet_2.z_vel_list[i] + planet_2.z_accel_list[i] * dt
